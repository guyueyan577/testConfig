...
{
    static final String PACKAGE = "com.zxycloud.autoConfig.db.mybatis.mapper.firepatrol";
    static final String MAPPER_LOCATION = "classpath:com/zxycloud/autoConfig/db/mybatis/map/firepatrol/*.xml";
