...
public class MyBatisConfig {
	static final String PACKAGE = "com.zxycloud.autoConfig.db.mybatis.mapper.biz";
    static final String MAPPER_LOCATION = "classpath:com/zxycloud/autoConfig/db/mybatis/map/biz/*.xml";
