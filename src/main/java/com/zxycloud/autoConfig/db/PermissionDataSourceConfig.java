...
{
    static final String PACKAGE = "com.zxycloud.autoConfig.db.mybatis.mapper.permission";
    static final String MAPPER_LOCATION = "classpath:com/zxycloud/autoConfig/db/mybatis/map/permission/*.xml";
