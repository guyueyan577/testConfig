...
{
    static final String PACKAGE = "com.zxycloud.autoConfig.db.mybatis.mapper.projectpermission";
    static final String MAPPER_LOCATION = "classpath:com/zxycloud/autoConfig/db/mybatis/map/projectpermission/*.xml";
